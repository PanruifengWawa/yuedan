...
<div id="centerWrapper">
    ...
    <div class="info-text regist">完善个人真实信息</div>
    <div class="info-text small jump">约单绝不会将您的学号密码用作他途</div>
    <div class="login-func-w regist jump">
        <span class="link" onclick="J.jump('main')">跳过此步,稍后完善</span>
    </div>
    <div jet-form="finish">
        <div class="input-w">
            <img src="resource/img/icon/img.png" alt="" class="icon">
            <input type="text" class="input big has-icon" placeholder="头像">
        ...
        <div class="input-w">
            <img src="resource/img/icon/name.png" alt="" class="icon">
            <input type="text" class="input big has-icon" placeholder="真实姓名（默认为学号）">
            <span class="valid">输入有误</span>
        </div>
        <div class="input-w">
            <img src="resource/img/icon/boy.png" alt="" class="icon">
            <input type="text" class="input big has-icon" placeholder="性别">
            <span class="valid">输入有误</span>
        </div>
        <div class="input-w">
        ...
        <div class="input-w">
            <img src="resource/img/icon/phone.png" alt="" class="icon">
            <input type="text" jet-valid="phone null" class="input big has-icon" placeholder="手机号">
            <span class="valid">输入有误</span>
        </div>
        <div class="input-w">
            <img src="resource/img/icon/email.png" alt="" class="icon">
            <input type="text" jet-valid="email null" class="input big has-icon" placeholder="邮箱">
            <span class="valid">输入有误</span>
        </div>
        <div class="input-w">
            <img src="resource/img/icon/dorm.png" alt="" class="icon">
            <input type="text" class="input big has-icon" placeholder="宿舍楼">
            <span class="valid">输入有误</span>
        </div>
        <div class="input-w">
            <img src="resource/img/icon/school.png" alt="" class="icon">
            <input type="text" class="input big has-icon" placeholder="学校名称">
            <span class="valid">输入有误</span>
            <span class="valid require">*</span>
        </div>
        <div class="input-w">
            <img src="resource/img/icon/area.png" alt="" class="icon">
            <input type="text" class="input big has-icon" placeholder="所在校区">
            <span class="valid">输入有误</span>
        </div>
        <div class="input-w">
            <img src="resource/img/icon/college.png" alt="" class="icon">
            <input type="text" class="input big has-icon" placeholder="学院">
            <span class="valid">输入有误</span>
        </div>
        <div class="input-w">
            <img src="resource/img/icon/major.png" alt="" class="icon">
            <input type="text" class="input big has-icon" placeholder="专业">
            <span class="valid">输入有误</span>
        </div>
        <div class="input-w">
            <img src="resource/img/icon/edu.png" alt="" class="icon">
            <input type="text" class="input big has-icon" placeholder="学历">
            <span class="valid">输入有误</span>
        </div>
        <div class="input-w">
            <img src="resource/img/icon/date.png" alt="" class="icon">
            <input type="text" class="input big has-icon" placeholder="入学年份">
            <span class="valid">输入有误</span>
        </div>
        <div class="input-w">
            <img src="resource/img/icon/role.png" alt="" class="icon">
            <input type="text" class="input big has-icon" placeholder="身份">
            <span class="valid">输入有误</span>
        </div>
        <div class="input-w">
            <img src="resource/img/icon/mine_b.png" alt="" class="icon">
            <input type="text" class="input big has-icon" placeholder="兴趣爱好">
            <span class="valid">输入有误</span>
        </div>
        <div class="input-w">
            <img src="resource/img/icon/single.png" alt="" class="icon">
            <input type="text" class="input big has-icon" placeholder="是否单身">
            <span class="valid">输入有误</span>
        </div>
        <div class="input-w">
            <img src="resource/img/icon/city.png" alt="" class="icon">
            <input type="text" class="input big has-icon" placeholder="祖籍" jet-name="city">
            <span class="valid">输入有误</span>
        </div>
    </div>
