...
J.ready(function(){
  J.cls("editor").each(function(item){
    ...
    var _title=J.ct("div.editor-title");
      ...
      for(var i=1;i<=40;i++){
        _face_box.append(J.ct("img.face-item[src=../resource/images/rabbit/rabbit ("+i+").gif][rt="+i+"]").clk(function(){
...
var Editor={
  ...
  uploadImg:function(){
    ...
    box.append(J.ct("img.editor-img").attr("src","../resource/images/404.png"));
    box.append(J.ct("br"));
  },
...
function initFaceBox(){
  J.class("face-box").each(function(box){
    ...
    for(var i=1;i<=40;i++){
      box.append(J.new("img.face-item[src=../resource/images/rabbit/rabbit ("+i+").gif][rt="+i+"][onclick=addFace(this)]"));
    }
  });
}